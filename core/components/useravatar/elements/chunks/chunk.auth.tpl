<div id='[[+propkey]]' class='user-avatar' data-avatar='[[+photo]]'>
    ...
    <div class='js-fileapi-wrapper user-avatar-btn btn btn-info'>
        ...
        <div class='user-avatar-upload-progress' style='display: none;'>
            ...
            <span class='user-avatar-btn-text'>uploading...</span>
        </div>
    </div>
</div>


<div class='user-avatar-popup popup' style='display: none;'>
    <div class='popup__body'><div class='user-avatar-upload-img'></div></div>
